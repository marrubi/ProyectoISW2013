	...
	<body>
		<div class="contenedor-total">
			...
			<section class="content">
				<h1>Bienvenido al perfil de Funcionario</h1>
				<h6>Aquí usted podrá:</h6>
				<h6>- Ver el estado de laboratorios y equipos, y habilitarlos/deshabilitarlos según corresponda</h6>
				<h6>- Registrar impresiones realizadas por estudiantes y ver las impresiones realizadas en el día</h6>
				<h6>- Ingresar un alumno al laboratorio y asignarle un equipo, así también registrar salida del alumno y liberar el equipo</h6>
				<h6>- Prestar un elemento del inventario a un profesor, y registrar su devolución</h6>
				<h6>- Registrar y editar una reserva realizada por un profesor</h6>
