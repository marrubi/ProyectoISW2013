...
--
-- Servidor: localhost
-- Tiempo de generación: 27-12-2013 a las 23:16:11
...
('25b185e538f7ffb1fd5bcb9db31ecbea', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36', 1388196189, 'a:2:{s:9:"user_data";s:0:"";s:9:"logged_in";a:1:{s:3:"rut";s:7:"8975653";}}'),
('6f61484a09643283428b1173b590f720', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36', 1388196060, '');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='registro de ingreso/salida de alumnos' AUTO_INCREMENT=9 ;

--
-- Volcado de datos para la tabla `tb-alumno-equipo`
--

INSERT INTO `tb-alumno-equipo` (`id`, `alumno-fk`, `equipo-fk`, `fecha_entrada`, `fecha_salida`) VALUES
(3, 3, 20, '2013-12-27 01:21:55', '2013-12-27 12:57:54'),
(4, 3, 23, '2013-12-27 12:57:29', '2013-12-27 12:57:59'),
(5, 1, 19, '2013-12-27 13:04:53', '2013-12-27 13:05:00'),
(6, 1, 24, '2013-12-27 13:10:59', '2013-12-27 13:12:04'),
(7, 3, 23, '2013-12-27 13:26:42', '2013-12-27 13:26:49'),
(8, 4, 19, '2013-12-27 13:56:33', '2013-12-27 13:56:44');
...
CREATE TABLE IF NOT EXISTS `tb-impresiones` (
  ...
  KEY `tipo_fk` (`tipo_fk`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='registro de impresiones de los alumnos' AUTO_INCREMENT=13 ;
...
(10, 3, 5, 1, '2013-12-27', '13:16:13'),
(11, 3, 5, 2, '2013-12-27', '13:50:22'),
(12, 3, 5, 1, '2013-12-27', '22:43:35');
...
(1, 'HP', 'Laserjet P2030', 432542, 2500, 'Imprime hojas tamaño A4, A3, Oficio, Sobre, etc.\r\nContiene 4 tóners, los cuales rinden 2500 impresiones.\r\nAl final de las impresiones, se debe cambiar tóner. ', '2013-12-18 13:30:00', 0, NULL);
